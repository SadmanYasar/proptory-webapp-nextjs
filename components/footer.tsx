        ...
        <footer className="pt-10 bg-black">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-red-500 shadow-sm rounded-lg"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-gradient-to-r from-red-500 to-pink-600 hover:animate-pulse active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <div className="text-gray-300 group transition duration-500"><a href="https://links-sadmanyasar.netlify.app/" target="_blank" rel="noreferrer">© 2023 Sadman Yasar Sayem.</a> <span>Images taken from <a href="https://www.freepik.com/free-photos-vectors/ai-generated" target="_blank" rel="noreferrer">Freepik</a></span>. <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-white"></span> </div>
                    <div className="flex items-center gap-x-6 text-gray-400 mt-6">
                        <a href="https://links-sadmanyasar.netlify.app/" target="_blank" rel="noreferrer">
